...
def _service(
    ...
    return ProblemService(problem_repository, test_case_repository, round_session_repository)
...
async def get_problem(
    ...
    try:
        return await service.get_problem_public(problem_id, current_user.id)
